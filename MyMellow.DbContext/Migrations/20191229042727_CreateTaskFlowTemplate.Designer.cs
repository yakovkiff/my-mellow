...
namespace MyMellow.DbContext.Migrations
{
    ...
    [Migration("20191229042727_CreateTaskFlowTemplate")]
    partial class CreateTaskFlowTemplate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyMellow.Domain.Models.TaskFlowTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("TaskFlowTemplate");
                });

            modelBuilder.Entity("MyMellow.Domain.Models.TaskFlowTemplatePhase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("TaskFlowTemplateId");

                    b.HasKey("Id");

                    b.HasIndex("TaskFlowTemplateId");

                    b.ToTable("TaskFlowTemplatePhase");
                });
            ...
            modelBuilder.Entity("MyMellow.Domain.Models.TaskPhase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MyMellow.Domain.Models.TaskFlowTemplatePhase", b =>
                {
                    b.HasOne("MyMellow.Domain.Models.TaskFlowTemplate", "Template")
                        .WithMany("Phases")
                        .HasForeignKey("TaskFlowTemplateId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("MyMellow.Domain.Models.TaskPhase", b =>
                {
                    b.HasOne("MyMellow.Domain.Models.TaskFlow", "TaskFlow")
                        .WithMany("Phases")
                        .HasForeignKey("TaskFlowId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
